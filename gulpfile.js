...
var cssTasks = function(filename) {
  return lazypipe()
    ...
    .pipe(function() {
      return gulpif(enabled.maps, sourcemaps.write('.', {sourceRoot: '/assets/sass/'}));
    })();
};
...
gulp.task("scss-lint", function() {
  ...
  return gulp.src(['assets/sass/**/*.scss',
    '!assets/sass/base/_roots_base.scss',
    '!assets/sass/utils/_mixin.scss',
...
gulp.task('watch', function() {
  ...
  gulp.watch([path.source + 'plugins/**/*.js'], ['jshint', 'scripts']);
...
gulp.task('wiredep', function() {
  ...
  return gulp.src(project.css)
    .pipe(wiredep())
    .pipe(changed(path.source + 'css/deps', {
      hasChanged: changed.compareSha1Digest
    }))
    .pipe(gulp.dest(path.source + 'css/deps'));
});
